...
urlpatterns = [
    ...
    path(
        "employee/complete/<int:booking_id>/",
        views.complete_booking,
        name="complete_booking",
    ),
    path(
        "employee/update-status/<int:booking_id>/",
    ...
    path(
        "admin-dashboard/employees/approve/<int:user_id>/",
        views.approve_employee,
        name="approve_employee",
    ),
    path(
        "admin-dashboard/employees/reject/<int:user_id>/",
        views.reject_employee,
        name="reject_employee",
    ),
    path("admin-dashboard/services/", views.manage_services, name="manage_services"),
    path(
        "admin-dashboard/services/delete/<int:service_id>/",
        views.delete_service,
        name="delete_service",
    ),
    path(
        "admin-dashboard/services/edit/<int:service_id>/",
        views.edit_service,
        name="edit_service",
    ),
    path(
        "admin-dashboard/services/toggle/<int:service_id>/",
        views.toggle_service,
        name="toggle_service",
    ),
